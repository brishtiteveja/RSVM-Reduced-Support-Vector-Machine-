...
extern int ufv(int, double *, double *p, double *);
extern int ugrad(int, double *, double *p, double *vB, double *);
extern int uhes(int, double *p, double *vB, double *);
extern int upv(int, double *x, double *vB, double *p);

extern void newvBp(double **vB, double **p);
extern void freevBp(double *vB, double *p);
extern double getNorm1(int, double *);
...
//     			if (getNorm1(n, g) < gtol)
	...
	upv(n, x, vB, p);
	ufv(n, x, p, &f);	
	printf("DTron iteration = %d,  obj = %f\n", iter, f);
